<template>
  <div class="app d-flex" style="background-color: #4f4752; height: 100vh">
    <div style="width: 180px" class="d-flex flex-column align-items-center">
      <div class="app-icon mt-5" style="width: 76px; height: 76px"></div>
      <div>
        <div class="mt-4 py-2 px-3 c-pointer">
          <div style="color: #fff; font-size: 20px">Главная</div>
        </div>
        <div
          class="mt-5 py-2 px-3 c-pointer"
          style="
          ...
          "
        >
          <div style="color: #4f4752; font-size: 20px">Управление</div>
        </div>
      </div>
    </div>
    <div
